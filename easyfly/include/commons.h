...
#define Circling 6
#define Funny 7
#define toBeReadyForBigRoll 8
#define TwostateTrj_S1 9
#define TwostateTrj_S2 10
#define TwostateTrj_S3 11
...
#define REVISE_WEIGHT 0.005 //dependes on the absolute value of error
